...
export function Hero() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-100 via-pink-50 to-cyan-100">
      {/* Navigation */}
      <nav className="border-b-2 border-cyan-400 bg-white sticky top-0 z-50 shadow-md">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <h1 className="text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
              Hello, I'm<br />
              <span className="bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">Prosper Yesuli</span>
            </h1>
